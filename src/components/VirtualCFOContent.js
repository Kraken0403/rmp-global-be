...
import sample from '../assets/Virtual CFO.jpeg'
import { Col, Row } from 'react-bootstrap'
import FeatureBox from './FeatureBox'

function VirtualCFOContent() {
  return (
                ...
                <div className="services-main-wrapper">
                    ...
                    <div className="services-features">
                        <div className="feature-boxes">
                            ...
                            <FeatureBox title="Tax & Legal Compliances" 
                            content="With an understanding of tax codes across several countries, we are capable of handling tax and relevant legal compliances for companies that operate globally! " />
                        ...
                        <div className="feature-boxes">
                            ...
                            <FeatureBox title="Government Incentives"
                                content="With various policies that favour businesses, especially in growing economies such as India, it is crucial to have a team that is capable of finding the right policy and incentive for your company! Our team constantly researches upcoming and existing government schemes that enable your company’s growth. "
                            />

                            <FeatureBox
                            title="Business Strategy"
                            content="Our Virtual CFO suite also helps companies in developing growth-oriented strategies that aim to enhance consumer engagement as well as drive down costs and optimizing procedures, leading to a two-pronged improvement approach!"
                            />

                        
                            <FeatureBox
                                title="HR Services"
                                content="A single-window destination for your HR Management services, whether it is documentation or managing payrolls for all your employees, our Virtual CFO offering takes care of it all."
                            />
...
export default VirtualCFOContent